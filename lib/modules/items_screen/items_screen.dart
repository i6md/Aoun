...
class ItemsScreen extends StatelessWidget {
  List<AdsModel> ads = [
    AdsModel(
        ...
        adPlace: "Online",
        photoUrl:
            'https://cdn.salla.sa/zRABG/7AnnbZo4Zqn1Q2yVhn7G4gSp6sqjGQn2blvGWhwN.jpg'),
    AdsModel(
        ...
        photoUrl:
            'https://img.kwcdn.com/product/and-screwdrivers/d69d2f15w98k18-eb3690be/Fancyalgo/VirtualModelMatting/7e235573cf7ba940ee0ce90c5b6d908d.jpg?imageView2/2/w/500/q/60/format/webp'),
    AdsModel(
        adName: "Tape Measure",
        ...
        photoUrl:
            'https://media.istockphoto.com/id/174798452/photo/tape-measure.jpg?s=612x612&w=0&k=20&c=iiJES37j8pSl_-7rhqiz-S4h8l9hpzXzcCwhxblrUyY='),
    AdsModel(
        adName: "Car Jack",
        adResourceType: "Image",
        adDate: "2024-03-20",
        adPlace: "Gym",
        photoUrl:
            'https://image.doba.com/dg7-AIFeYyTFQKbL/3t-low-profile-jack-red-and-black-ultra-low-floor-jack-with-dual-pistons-quick-lift-pump-car-jack-hydraulic-autolifts-for-home-garage-truck-jack-hydraulic-lifting-range-33-197.webp'),
    AdsModel(
        adName: "Vacuum Cleaner",
        adResourceType: "Image",
        adDate: "2024-03-10",
